...
<form class="form-horizontal" action="insertOwner.jsp" method="POST" style = "margin-left:400px">
  <fieldset>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" id="fname" name="lname" placeholder="" class="input-xlarge">
      </div>
    </div>
